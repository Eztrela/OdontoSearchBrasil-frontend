...
const Q1 = [17, 16, 15, 14, 13, 12, 11]
const Q2 = [21, 22, 23, 24, 25, 26, 27]
const Q3 = [31, 32, 33, 34, 35, 36, 37]
const Q4 = [47, 46, 45, 44, 43, 42, 41]
const ALL_TEETH = [...Q1, ...Q2, ...Q3, ...Q4]

const SUPERIOR_TEETH = [11, 12, 13, 14, 15, 16, 17, 21, 22, 23, 24, 25, 26, 27]
const INFERIOR_TEETH = [31, 32, 33, 34, 35, 36, 37, 41, 42, 43, 44, 45, 46, 47]
